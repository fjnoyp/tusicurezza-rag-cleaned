      ...
      <Card>
        <CardContent>
          <Stack divider={<Divider />} spacing={4}>
            <Stack spacing={3}>
              <Typography variant="h6">{t('invoiceCreateForm.basicInformation')}</Typography>
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <FormControl error={Boolean(errors.customer)} fullWidth>
                        <InputLabel>{t('invoiceCreateForm.customer')}</InputLabel>
                        <OutlinedInput {...field} />
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <FormControl disabled fullWidth>
                        <InputLabel>{t('invoiceCreateForm.number')}</InputLabel>
                        <OutlinedInput {...field} />
                      </FormControl>
                    )}
                  />
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <FormControl error={Boolean(errors.taxId)} fullWidth>
                        <InputLabel>{t('invoiceCreateForm.taxId')}</InputLabel>
            ...
            <Stack spacing={3}>
              <Typography variant="h6">{t('invoiceCreateForm.lineItems')}</Typography>
                  ...
                  <Stack direction="row" key={lineItem.id} spacing={3} sx={{ alignItems: 'center', flexWrap: 'wrap' }}>
                    <Controller
                      ...
                      render={({ field }) => (
                        ...
                        >
                          <InputLabel>{t('invoiceCreateForm.description')}</InputLabel>
                          <OutlinedInput {...field} />
                    ...
                    <Controller
                      ...
                      render={({ field }) => (
                        ...
                        >
                          <InputLabel>{t('invoiceCreateForm.service')}</InputLabel>
                          <Select {...field}>
                            <Option value="">{t('invoiceCreateForm.selectService')}</Option>
                            <Option value="design">{t('invoiceCreateForm.design')}</Option>
                            <Option value="development">{t('invoiceCreateForm.development')}</Option>
                          </Select>
                    ...
                    <Controller
                      ...
                      render={({ field }) => (
                        <FormControl error={Boolean(errors.lineItems?.[index]?.quantity)} sx={{ width: '140px' }}>
                          <InputLabel>{t('invoiceCreateForm.quantity')}</InputLabel>
                          <OutlinedInput
                            {...field}
                            inputProps={{ step: 1 }}
                    ...
                    <Controller
                      ...
                      render={({ field }) => (
                        <FormControl error={Boolean(errors.lineItems?.[index]?.unitPrice)} sx={{ width: '140px' }}>
                          <InputLabel>{t('invoiceCreateForm.unitPrice')}</InputLabel>
                          <OutlinedInput
                            {...field}
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <FormControl error={Boolean(errors.discount)} fullWidth>
                      <InputLabel>{t('invoiceCreateForm.discount')}</InputLabel>
                      <OutlinedInput
                        {...field}
                        inputProps={{ step: 0.01 }}
                        onChange={(event: React.ChangeEvent<HTMLInputElement>) => {
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <FormControl error={Boolean(errors.shippingRate)} fullWidth>
                      <InputLabel>{t('invoiceCreateForm.shippingRate')}</InputLabel>
                      <OutlinedInput
                        {...field}
                        inputProps={{ step: 0.01 }}
                        onChange={(event: React.ChangeEvent<HTMLInputElement>) => {
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <FormControl error={Boolean(errors.taxRate)} fullWidth>
                      <InputLabel>{t('invoiceCreateForm.taxRate')} (%)</InputLabel>
                      <OutlinedInput
                        {...field}
                        inputProps={{ step: 0.01 }}
                        onChange={(event: React.ChangeEvent<HTMLInputElement>) => {
            ...
            <Box sx={{ display: 'flex', justifyContent: 'flex-end' }}>
              <Stack spacing={2} sx={{ width: '300px', maxWidth: '100%' }}>
                <Stack direction="row" spacing={3} sx={{ justifyContent: 'space-between' }}>
                  <Typography variant="body2">{t('invoiceCreateForm.subtotal')}</Typography>
                  <Typography variant="body2">
                    {new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD' }).format(subtotal)}
                  </Typography>
                </Stack>
                <Stack direction="row" spacing={3} sx={{ justifyContent: 'space-between' }}>
                  <Typography variant="body2">{t('invoiceCreateForm.discount')}</Typography>
                  <Typography variant="body2">
                    {discount
                ...
                <Stack direction="row" spacing={3} sx={{ justifyContent: 'space-between' }}>
                  <Typography variant="body2">{t('invoiceCreateForm.shipping')}</Typography>
                  <Typography variant="body2">
                    {shippingRate
                ...
                <Stack direction="row" spacing={3} sx={{ justifyContent: 'space-between' }}>
                  <Typography variant="body2">{t('invoiceCreateForm.taxes')}</Typography>
                  <Typography variant="body2">
                    {tax ? new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD' }).format(tax) : '-'}
                  </Typography>
                </Stack>
                <Stack direction="row" spacing={3} sx={{ justifyContent: 'space-between' }}>
                  <Typography variant="subtitle1">{t('invoiceCreateForm.total')}</Typography>
        ...
        <CardActions sx={{ justifyContent: 'flex-end' }}>
          <Button color="secondary">{t('invoiceCreateForm.cancel')}</Button>
          <Button type="submit" variant="contained">
            {t('invoiceCreateForm.createInvoice')}
          </Button>
        </CardActions>
      </Card>
    </form>
