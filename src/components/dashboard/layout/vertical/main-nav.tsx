...
import { languageFlags, LanguagePopover } from '../../../core/language-popover';
import type { Language } from '../../../core/language-popover';
...
export function MainNav({ items, onButtonClick }: MainNavProps): React.JSX.Element {
      ...
      >
        ...
        >
          <Stack direction="row" spacing={2} sx={{ alignItems: 'center', flex: '1 1 auto' }}>
            ...
            <IconButton onClick={onButtonClick} sx={{ display: { xs: 'none', lg: 'block' } }}>
              <ListIcon />
            </IconButton>
          </Stack>
          <Stack
