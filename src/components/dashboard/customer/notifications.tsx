        ...
        <Stack spacing={3}>
          <Stack spacing={2}>
            <Select defaultValue="last_invoice" name="type" sx={{ maxWidth: '100%', width: '320px' }}>
              <Option value="last_invoice">{t('notifications.resendLastInvoice')}</Option>
              <Option value="password_reset">{t('notifications.sendPasswordReset')}</Option>
              <Option value="verification">{t('notifications.sendVerification')}</Option>
            </Select>
            <div>
