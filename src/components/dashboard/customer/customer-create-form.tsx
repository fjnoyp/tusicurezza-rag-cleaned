...
export function CustomerCreateForm(): React.JSX.Element {
  ...
  const onSubmit = React.useCallback(
    async (_: Values): Promise<void> => {
      try {
        // Make API request
        toast.success(t('customerCreateForm.customerCreated'));
        router.push(paths.dashboard.customers.details('1'));
      } catch (err) {
        logger.error(err);
        toast.error(t('customerCreateForm.error'));
      }
    },
    [router, t]
  );
      ...
      <Card>
        <CardContent>
          <Stack divider={<Divider />} spacing={4}>
            <Stack spacing={3}>
              <Typography variant="h6">{t('customerCreateForm.accountInformation')}</Typography>
                ...
                <Grid xs={12}>
                  <Stack direction="row" spacing={3} sx={{ alignItems: 'center' }}>
                    ...
                    <Stack spacing={1} sx={{ alignItems: 'flex-start' }}>
                      <Typography variant="subtitle1">{t('customerCreateForm.avatar')}</Typography>
                      <Typography variant="caption">{t('customerCreateForm.avatarDescription')}</Typography>
                      <Button
                        color="secondary"
                        onClick={() => {
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <FormControl error={Boolean(errors.name)} fullWidth>
                        <InputLabel required>{t('customerCreateForm.name')}</InputLabel>
                        <OutlinedInput {...field} />
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <FormControl error={Boolean(errors.email)} fullWidth>
                        <InputLabel required>{t('customerCreateForm.email')}</InputLabel>
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <FormControl error={Boolean(errors.phone)} fullWidth>
                        <InputLabel required>{t('customerCreateForm.phone')}</InputLabel>
                        <OutlinedInput {...field} />
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <FormControl error={Boolean(errors.company)} fullWidth>
                        <InputLabel>{t('customerCreateForm.company')}</InputLabel>
                        <OutlinedInput {...field} />
            ...
            <Stack spacing={3}>
              <Typography variant="h6">{t('customerCreateForm.billingInformation')}</Typography>
              <Grid container spacing={3}>
                <Grid md={6} xs={12}>
                  <Controller
                    control={control}
                    ...
                    render={({ field }) => (
                      <FormControl error={Boolean(errors.billingAddress?.country)} fullWidth>
                        <InputLabel required>{t('customerCreateForm.country')}</InputLabel>
                        <Select {...field}>
                          <Option value="">{t('customerCreateForm.chooseACountry')}</Option>
                        </Select>
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <FormControl error={Boolean(errors.billingAddress?.state)} fullWidth>
                        <InputLabel required>{t('customerCreateForm.state')}</InputLabel>
                        <OutlinedInput {...field} />
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <FormControl error={Boolean(errors.billingAddress?.city)} fullWidth>
                        <InputLabel required>{t('customerCreateForm.city')}</InputLabel>
                        <OutlinedInput {...field} />
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <FormControl error={Boolean(errors.billingAddress?.zipCode)} fullWidth>
                        <InputLabel required>{t('customerCreateForm.zipCode')}</InputLabel>
                        <OutlinedInput {...field} />
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <FormControl error={Boolean(errors.billingAddress?.line1)} fullWidth>
                        <InputLabel required>{t('customerCreateForm.address')}</InputLabel>
                        <OutlinedInput {...field} />
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <FormControl error={Boolean(errors.taxId)} fullWidth>
                        <InputLabel>{t('customerCreateForm.taxId')}</InputLabel>
            ...
            <Stack spacing={3}>
              <Typography variant="h6">{t('customerCreateForm.shippingInformation')}</Typography>
              <FormControlLabel
                control={<Checkbox defaultChecked />}
                label={t('customerCreateForm.sameAsBillingAddress')}
              />
            </Stack>
            <Stack spacing={3}>
              <Typography variant="h6">{t('customerCreateForm.additionalInformation')}</Typography>
              <Grid container spacing={3}>
                <Grid md={6} xs={12}>
                  <Controller
                    control={control}
                    ...
                    render={({ field }) => (
                      <FormControl error={Boolean(errors.timezone)} fullWidth>
                        <InputLabel required>{t('customerCreateForm.timezone')}</InputLabel>
                        <Select {...field}>
                          <Option value="">{t('customerCreateForm.selectATimezone')}</Option>
                        </Select>
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <FormControl error={Boolean(errors.language)} fullWidth>
                        <InputLabel required>{t('customerCreateForm.language')}</InputLabel>
                        <Select {...field}>
                          <Option value="">{t('customerCreateForm.selectALanguage')}</Option>
                        </Select>
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <FormControl error={Boolean(errors.currency)} fullWidth>
                        <InputLabel>{t('customerCreateForm.currency')}</InputLabel>
                        <Select {...field}>
                          <Option value="">{t('customerCreateForm.selectACurrency')}</Option>
                          <Option value="USD">{t('customerCreateForm.usd')}</Option>
                          <Option value="EUR">{t('customerCreateForm.eur')}</Option>
                          <Option value="RON">{t('customerCreateForm.ron')}</Option>
                        </Select>
        ...
        <CardActions sx={{ justifyContent: 'flex-end' }}>
          <Button color="secondary" component={RouterLink} href={paths.dashboard.customers.list}>
            {t('customerCreateForm.cancel')}
          </Button>
          <Button type="submit" variant="contained">
            {t('customerCreateForm.createCustomer')}
          </Button>
        </CardActions>
      </Card>
    </form>
