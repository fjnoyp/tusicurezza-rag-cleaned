            ...
            <Stack direction="row" spacing={2} sx={{ alignItems: 'center' }}>
              <InvoicePDFLink invoice={undefined}>
                <Button color="secondary">
                  <TranslateText ns={LangNs.Invoices} textKey="download" />
                </Button>
              </InvoicePDFLink>
              <Button component="a" href={paths.pdf.invoice('1')} target="_blank" variant="contained">
                <TranslateText ns={LangNs.Invoices} textKey="preview" />
              </Button>
            </Stack>
          </Stack>
        </Stack>
          ...
          <Stack spacing={6}>
            <Stack direction="row" spacing={3} sx={{ alignItems: 'flex-start' }}>
              <Box sx={{ flex: '1 1 auto' }}>
                <Typography variant="h4">
                  <TranslateText ns={LangNs.Invoices} textKey="invoice" />
                </Typography>
              </Box>
            ...
            <Stack spacing={1}>
              <Stack direction="row" spacing={2} sx={{ alignItems: 'center' }}>
                <Box sx={{ flex: '0 1 150px' }}>
                  <Typography variant="subtitle2">
                    <TranslateText ns={LangNs.Invoices} textKey="number" />:
                  </Typography>
                </Box>
                <div>
              ...
              <Stack direction="row" spacing={2} sx={{ alignItems: 'center' }}>
                <Box sx={{ flex: '0 1 150px' }}>
                  <Typography variant="subtitle2">
                    <TranslateText ns={LangNs.Invoices} textKey="dueDate" />:
                  </Typography>
                </Box>
                <div>
              ...
              <Stack direction="row" spacing={2} sx={{ alignItems: 'center' }}>
                <Box sx={{ flex: '0 1 150px' }}>
                  <Typography variant="subtitle2">
                    <TranslateText ns={LangNs.Invoices} textKey="issueDate" />:
                  </Typography>
                </Box>
                <div>
              ...
              <Stack direction="row" spacing={2} sx={{ alignItems: 'center' }}>
                <Box sx={{ flex: '0 1 150px' }}>
                  <Typography variant="subtitle2">
                    <TranslateText ns={LangNs.Invoices} textKey="issuerVATNo" />:
                  </Typography>
                </Box>
            ...
            <Grid container spacing={3}>
              ...
              <Grid md={6} xs={12}>
                <Stack spacing={1}>
                  <Typography variant="subtitle1">Fatturato a</Typography>
                  <Typography variant="body2">
                    Miron Vitold
                    <br />
                    Acme Inc.
            ...
            <Stack spacing={2}>
              ...
              <Stack spacing={2}>
                <Stack direction="row" spacing={2} sx={{ alignItems: 'center', justifyContent: 'flex-end' }}>
                  <Box sx={{ flex: '0 1 150px' }}>
                    <Typography>
                      <TranslateText ns={LangNs.Invoices} textKey="subtotal" />
                    </Typography>
                  </Box>
                ...
                <Stack direction="row" spacing={2} sx={{ alignItems: 'center', justifyContent: 'flex-end' }}>
                  <Box sx={{ flex: '0 1 150px' }}>
                    <Typography>
                      <TranslateText ns={LangNs.Invoices} textKey="tax" />
                    </Typography>
                  </Box>
                  <Box sx={{ flex: '0 1 100px', textAlign: 'right' }}>
                    <Typography>
                ...
                <Stack direction="row" spacing={2} sx={{ alignItems: 'center', justifyContent: 'flex-end' }}>
                  <Box sx={{ flex: '0 1 150px' }}>
                    <Typography variant="h6">
                      <TranslateText ns={LangNs.Invoices} textKey="total" />
                    </Typography>
                  </Box>
                  <Box sx={{ flex: '0 1 100px', textAlign: 'right' }}>
                    <Typography variant="h6">
            ...
            <Stack spacing={1}>
              <Typography variant="h6">
                <TranslateText ns={LangNs.Invoices} textKey="notes" />
              </Typography>
              <Typography color="text.secondary" variant="body2">
                <i>
                  Si prega di assicurarsi di avere il giusto numero di registrazione bancaria poiché ho avuto problemi
                  in passato e assicurarsi di coprire le spese di trasferimento.
                </i>
              </Typography>
            </Stack>
          </Stack>
