...
export const config = {
  ...
  supabase: { url: 'https://macekdbllzcekboigxis.supabase.co', anonKey: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im1hY2VrZGJsbHpjZWtib2lneGlzIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MTcwMjU5MTEsImV4cCI6MjAzMjYwMTkxMX0.2FVej4qfyeKjxymGmEiDUhaVlK40_j_Wagm1WJQdzt0' },
